        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustRef = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    VendorTransactionRef = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TransactionType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VendorCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Password = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Teller = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Reversal = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TeversedTrans = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Offline = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UtilityCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManufacutredDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductAttributesId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductReviews_ProductAttributes_ProductAttributesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReviews_ProductAttributesId",
